/**
 * SuggestPhaseBoundary Application Layer
 *
 * CLI 和 MCP adapter 统一通过此入口调用阶段边界建议业务逻辑。
 */
...
export interface SuggestPhaseBoundaryInput {
  repo_path: string;
  current_phase: TaskCheckpoint['phase'];
  checkpoint_id?: string;
  checkpoint?: z.infer<typeof taskCheckpointSchema>;
  retrieval_signal?: RetrievalSignal;
  assembly_signal?: AssemblySignal;
...
export async function executeSuggestPhaseBoundary(
